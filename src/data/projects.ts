...
export const projects: Project[] = [
  ...
  // 5. ONIKIRI --------------------------------------------------------------
  {
    ...
    summary: '세로형 모바일 방치 RPG. BigNumber, 자동 전투, 보스 게이트, 성장 밸런스 시뮬레이션을 중심으로 구현.',
    systemTags: ['Unity 2D', 'Idle RPG', 'BigDouble', 'Save / Offline', 'Balance Sim'],
    status: 'IN_DEVELOPMENT',
    accent: 'amber',
    sections: [
      {
        ...
        kind: 'bullets',
        items: [
          'ONIKIRI(로닌 키우기)는 Unity 6와 Universal 2D(URP)를 기반으로 제작 중인 세로형 모바일 방치 RPG 프로젝트입니다.',
          '플레이어는 고정된 사무라이가 우측에서 몰려오는 요괴를 자동으로 베는 전투 루프를 보고, 골드·경험치·보석을 통해 공격력, 공격속도, 치명타, 스킬, 장비, 전직, 동료, 심화 축을 성장시킵니다.',
          '프로젝트의 핵심은 단순한 자동 전투 구현보다, 방치형 게임에서 긴 시간 누적되는 수치·세이브·오프라인 보상·스테이지 밸런스가 서로 어긋나지 않도록 하나의 계산 모델과 테스트로 묶는 데 두었습니다.',
      ...
      },
      {
        ...
        rows: [
          ...
          [
            '핵심 시스템',
            '자동 전투, BigDouble 수치 체계, 스테이지/보스 게이트, 성장 곡선, 세이브/오프라인 보상, 퀘스트, 장비, 전직, 동료, 심화 축',
          ],
          [
            '사용 기술',
            'Unity 2D, URP, Pixel Perfect Camera, TextMeshPro, ScriptableObject, JsonUtility Save, EditMode Test Framework, EditorWindow / Scene Builder',
          ],
      ...
      },
      {
        ...
        items: [
          ...
          'EditMode 테스트 337개 기준으로 BigDouble, 저장 마이그레이션, 스테이지 진행, 보스 게이트, 성장 효율, UI 레이아웃, 지역 배경, 스킬/장비/동료/전직 밸런스를 검증',
        ],
      },
      {
        key: 'highlight',
        ...
        items: [
          ...
          'EditMode 테스트로 곡선 밴드, 저장 마이그레이션, BigDouble 정확도, Pixel Perfect 레이아웃, BossRoster, Skill/Equipment/Pet/Evolution 축을 자동 검증',
        ],
      },
      {
        key: 'detail',
      ...
      },
      {
        ...
        label: '불릿 포인트',
        kind: 'bullets',
        note: 'ONIKIRI는 Unity 기반 모바일 방치 RPG지만, 포트폴리오 관점에서는 자동 전투보다 수치 성장, 저장 안정성, 밸런스 시뮬레이션, 모바일 UI 검증 파이프라인을 보여주는 시스템 프로젝트입니다.',
        items: [
          '# Unity 6 모바일 세로형 방치 RPG · BigNumber 성장 시스템 · 테스트 기반 밸런싱',
          '가수부/지수부 기반 BigDouble 구현으로 골드, 데미지, 비용, 경험치의 대형 수치 처리',
          '자동 발도 전투, 공격속도 기반 스윙 압축, 히트스톱/흔들림/이펙트 예산 조정으로 후반 타격감 유지',
          'StageProgress / BossFight / BossRoster 기반 스테이지 파밍, 보스 게이트, 지역 피날레 진행 구조 구현',
          'SaveSystem / GameSession 기반 JSON 저장, 세이브 버전 마이그레이션, 오프라인 보상 계산 구조 구현',
          'StageSimulation과 337개 EditMode 테스트로 성장 곡선, 보스 여유, 죽은 버튼, UI 레이아웃, 저장 안정성 검증',
